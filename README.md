...
* Lua for neovim
* Swift for AppKit, UIKit, SwifttUI, Swift SKIP, and Vapor, also worth a look: https://github.com/kkharji/xbase; this is how I installed SourceKit-LSP under macOS and Ubuntu 22.04 LTS https://gist.github.com/TyrfingMjolnir/ad7bbc1940f1dcf218204b3149d488ed
* XML / XSLT for CoreData aka xcdatamodel, Storyboard / XIB / NIB, EHF, and UBL
* Rust for Yex/Axum and RataTUI
* Python for science and certain communication
* JSON for UI
